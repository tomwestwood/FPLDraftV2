...
@Component({
  selector: 'app-fancast-review-component',
  templateUrl: './fancast-review.component.html',
  styleUrls: ['./fancast-review.component.scss'],
  animations: [
    trigger('flyInOut', [
...
export class FancastReviewComponent implements OnInit {
