...
@Component({
  selector: 'app-terminal-old-component',
  templateUrl: './terminal-old.component.html',
  styleUrls: ['./terminal-old.component.scss'],
  animations: [
    trigger('flyInOut', [
...
export class TerminalOldComponent implements OnInit {
  fplBase: FPLBase;
